# -*- coding: utf-8 -*-
"""ConvNeXt-Tiny_Faradade_73.24.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1nDKvBzuECPBF6jdN73y5HMEhRSbLwt7H
"""
...
# --- Image Branch with ConvNeXt-Tiny (CNN) ---
...
print("\nStarting multi-modal model training with ConvNeXt-Tiny...")
history = model.fit(
    train_dataset,
    epochs=EPOCHS,
...
plt.title('Confusion Matrix for Multi-Modal ConvNeXt-Tiny')
plt.show()